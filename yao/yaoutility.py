...
class FileDomainDictionary:
    def __init__(self, input_file):
        self.file_domain_dictionary = dict()
        for line in input_file:
            ...
            if path.endswith('/'):
                ...
                self.file_domain_dictionary[filename] = '.'.join(domain)

    def domain_of(self, word):
        # word = word.lower()
        if word in self.file_domain_dictionary:
            return self.file_domain_dictionary[word]
        else:
            return None
